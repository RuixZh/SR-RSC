...
class evaluation_metrics():
    ...
    def evaluation_lp(self, node1, node2, label):
        ...
        print('AUC: %.5f, AP: %.5f, PR: %.5f, ACC: %.5f, F1_micro: %.5f, F1_macro: %.5f'%(auc, ap, pr, acc, f1_micro, f1_macro))
...
#         for rs in [0,123,432,6543,8478643]:
        for rs in [0]:
            ...
            fis+=f1_micro
            fas+=f1_macro
        print('NMI=%.5f, ARI: %.5f, f1_micro=%.5f, f1_macro=%.5f' % (nmis, adjscores, fis, fas))
